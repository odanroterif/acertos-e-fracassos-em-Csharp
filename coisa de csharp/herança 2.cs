...
namespace herança_2
{
    ...
    internal class Program
    {
        ...
        Start:
            ...
            string resward = Console.ReadLine();
            Console.Clear();
            if (resward == "Vaca" || resward == "vaca")
            {
                do
                {
                    Console.WriteLine("quer bater nesse mob?\n");
                    resward = Console.ReadLine();
                    resward = resward.ToLower();
                    Console.Clear();
            ...
            else if (resward == "enderman" || resward == "Enderman")
            {
                do
                {
                    Console.WriteLine("quer bater nesse mob?\n");
            ...
            else if (resward == "zumbi" || resward == "Zumbi")
            {
                do
                {
                    Console.WriteLine("quer bater nesse mob?\n");
